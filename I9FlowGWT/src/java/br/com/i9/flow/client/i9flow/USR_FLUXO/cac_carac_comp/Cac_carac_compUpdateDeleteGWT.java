 ...
 * @author geoleite
 */
public class Cac_carac_compUpdateDeleteGWT extends AlterarExcluirBaseGWT {
    ...
    public Cac_carac_compUpdateDeleteGWT() {
        setHeading("Alterar Cac_carac_comp");
    ...
    public void load(Cac_carac_compTGWT cac_carac_compT) {
	this.cac_carac_compT = cac_carac_compT;
		tra_nr_id.setValue(cac_carac_compT.getTra_nr_id() + "");
		tel_nr_id.setValue(cac_carac_compT.getTel_nr_id() + "");
		cac_nr_id.setValue(cac_carac_compT.getCac_nr_id() + "");
		cac_tx_idcomponente.setValue(cac_carac_compT.getCac_tx_idcomponente());
		cac_tx_visivel.setValue(cac_carac_compT.getCac_tx_visivel());
		cac_tx_habilitado.setValue(cac_carac_compT.getCac_tx_habilitado());
		cac_tx_editavel.setValue(cac_carac_compT.getCac_tx_editavel());
	...
	cac_carac_compDao.alterar(cac_carac_compT);
    ...
    public void btnDeltAction(ButtonEvent ce) {
        ...
        MessageBox.confirm("Aviso", "Tem certeza que deseja excluir registro?", new Listener<MessageBoxEvent>() {
		  ...
		  cac_carac_compDao.excluir(cac_carac_compT);
		  Timer timer = new Timer() {
	   	    public void run() {
 	     		String msg = cac_carac_compDao.getMsg();
 	     		if (msg == null) {
