 ...
 * @author geoleite
 */
public class Lgc_logicaInsertGWT extends CadastrarBaseGWT  {
    ...
    public Lgc_logicaInsertGWT() {
	setHeading("Cadastrar Lgc_logica");
	...
	Lgc_logicaTGWT lgc_logicaT = new Lgc_logicaTGWT();
        ...
        lgc_logicaDao.inserir(lgc_logicaT);
    ...
    public void btnLimpartAction(ButtonEvent ce){
			lgc_nr_id.setValue("");
		tra_nr_id.setValue("");
		lgc_tx_classe.setValue("");
		lgc_tx_status.setValue("");
		lgc_nr_ordem.setValue("");
		lgc_tx_descricao.setValue("");
