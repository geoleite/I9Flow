 ...
 * @author geoleite
 */
public class Tra_tramiteUpdateDeleteGWT extends AlterarExcluirBaseGWT {
    ...
    public Tra_tramiteUpdateDeleteGWT() {
        setHeading("Alterar Tra_tramite");
    ...
    public void load(Tra_tramiteTGWT tra_tramiteT) {
	this.tra_tramiteT = tra_tramiteT;
		tra_nr_id.setValue(tra_tramiteT.getTra_nr_id() + "");
		des_nr_id.setValue(tra_tramiteT.getDes_nr_id() + "");
		tid_nr_id.setValue(tra_tramiteT.getTid_nr_id() + "");
		usu_nr_id.setValue(tra_tramiteT.getUsu_nr_id() + "");
		tra_tx_nome.setValue(tra_tramiteT.getTra_tx_nome());
		tra_tx_automatico.setValue(tra_tramiteT.getTra_tx_automatico());
	...
	tra_tramiteDao.alterar(tra_tramiteT);
    ...
    public void btnDeltAction(ButtonEvent ce) {
        ...
        MessageBox.confirm("Aviso", "Tem certeza que deseja excluir registro?", new Listener<MessageBoxEvent>() {
		  ...
		  tra_tramiteDao.excluir(tra_tramiteT);
		  Timer timer = new Timer() {
	   	    public void run() {
 	     		String msg = tra_tramiteDao.getMsg();
 	     		if (msg == null) {
