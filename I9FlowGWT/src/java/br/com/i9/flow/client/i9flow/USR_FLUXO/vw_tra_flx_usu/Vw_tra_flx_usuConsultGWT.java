 ...
 * @author geoleite
 */
public class Vw_tra_flx_usuConsultGWT extends CPConsultarBaseGWT {

    private List<ColumnConfig> configs = new ArrayList<ColumnConfig>();
    private Vw_tra_flx_usuDAOGWT vw_tra_flx_usuDao = new Vw_tra_flx_usuDAOGWT();

    public Vw_tra_flx_usuConsultGWT() {
...
//        configs.add(column);
        ...
        column = new ColumnConfig();
        column.setId("viewObs");
        column.setHeader("");
        column.setWidth(30);
        column.setRenderer(getViewObsRender());
    ...
    public void btnNovoAction(ButtonEvent be) {
        Vw_tra_flx_usuInsertGWT vw_tra_flx_usuInsertGWT = new Vw_tra_flx_usuInsertGWT();
        vw_tra_flx_usuInsertGWT.setVw_tra_flx_usuConsult(this);
        vw_tra_flx_usuInsertGWT.setModal(true);
        vw_tra_flx_usuInsertGWT.show();
    }

    private GridCellRenderer<Vw_tra_flx_usuTGWT> getViewObsRender() {
            ...
            public Object render(final Vw_tra_flx_usuTGWT model, String property, ColumnData config, final int rowIndex,
                ...
                b.addListener(Events.OnClick, new Listener<ButtonEvent>() {
                    ...
                    public void handleEvent(ButtonEvent be) {
                        ...
                        vw_tra_flx_usuUpdateDeleteGWT.setVw_tra_flx_usuConsult(Vw_tra_flx_usuConsultGWT.this);
    ...
    public void load(List<Did_documento_identificacaoTGWT> listIdsDocumentos) {
        vw_tra_flx_usuDao.consultByIdDocumento(listIdsDocumentos);
