 ...
 * @author geoleite
 */
public class Flx_fluxoInsertGWT extends CadastrarBaseGWT {
    ...
    public Flx_fluxoInsertGWT() {
        setHeading("Cadastrar Flx_fluxo");
    ...
    public void btnInsertAction(ButtonEvent ce) {
        Flx_fluxoTGWT flx_fluxoT = new Flx_fluxoTGWT();
        ...
        flx_fluxoDao.inserir(flx_fluxoT);
